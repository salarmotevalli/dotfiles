...
# Download using curl with -L to follow redirects and -o to specify output path
curl -L -o "$download_folder/Bibata-Modern-Amber.tar.xz" "$bibata_url/Bibata-Modern-Amber.tar.xz"
curl -L -o "$download_folder/Bibata-Modern-Classic.tar.xz" "$bibata_url/Bibata-Modern-Classic.tar.xz"
curl -L -o "$download_folder/Bibata-Modern-Ice.tar.xz" "$bibata_url/Bibata-Modern-Ice.tar.xz"
...
if [ -d ~/.local/share/icons/Bibata-Modern-Ice ]; then  # Fixed: was incorrectly checking Amber again
